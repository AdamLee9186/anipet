...
function prepareCopyElements() {
    ...
    tmcEnsureDataLabelsForTable(table);
            ...
            table.querySelectorAll('tbody tr').forEach((row, rowIndex) => {
                ...
                Array.from(row.cells).forEach(cell => {
                    ...
                    if (dataLabel === 'איזור חלוקה' || dataLabel === 'איזור') {
                        areaText = (cell.textContent || '').trim();
                    }
                    ...
                    if (dataLabel === 'נהג') {
                        ...
                        if (select2Rendered) {
                            driverText = select2Rendered.textContent.trim();
                        } else {
                            driverText = (cell.textContent || '').trim();
                        }
                    }
                });
