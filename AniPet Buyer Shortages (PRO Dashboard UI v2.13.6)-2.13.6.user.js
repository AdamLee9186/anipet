// ==UserScript==
// @name         AniPet Buyer Shortages (PRO Dashboard UI v2.13.6)
// @namespace    anipet.buyer
// @version      2.13.6
// @description  Stealth classes for action icons to completely bypass toolbox.js interference.
...
(() => {
  ...
  const css = `
    ...
    /* ✨ תיקון חומת מגן מוחלטת לאייקונים (גרסה 2.13.6) ✨ */
    /* משתמשים במחלקות סודיות כדי ש-toolbox.js לא יזהה אותם לעולם */
    .ani-actions-container {
        display: inline-flex !important;
        align-items: center !important;
        gap: 8px !important;
        direction: ltr !important; /* LTR מבטיח שהמספר יופיע בצד שמאל והאייקונים מימינו, או ההפך - תלוי בסדר ב-DOM */
    }
    ...
    .ani-action-btn {
        ...
        margin: 0 !important;
        padding: 0 !important;
        color: #3699ff !important; /* צבע התכלת הנדרש */
    ...
    .ani-action-btn i {
        ...
        margin: 0 !important;
        padding: 0 !important;
        color: inherit !important; /* יורש את התכלת מהאב */
    }
  `;
  ...
  // ✨ שכתוב קומפוננטת הטלפון כדי להבטיח עמידות מול toolbox.js
  function getPhoneNode(phone, name) {
      ...
      // שימוש ב-ani-action-btn (שם סודי ש-toolbox לא מכיר)
      ...
      // עטיפה עם ltr כדי לוודא שהאייקונים מסודרים לפני המספר מימין לשמאל
      return el("span", { className: "ani-actions-container" }, [
          histBtn, telBtn, waBtn, // האייקונים קודם
          el("span", { textContent: dispPhone, style: { fontWeight: "600", color: "#0f172a" } }) // המספר אחרון
      ]);
  }
  ...
  const headerDiv = el("div", { id: "anipet-pro-header" }, [
    el("div", { style: { display: "flex", alignItems: "center", gap: "12px" } }, [
      ...
      el("div", {}, [
        ...
        el("div", { textContent: "V2.13.6 - Clean UI & Protected Icons", style: { fontSize: "12px", color: "#94a3b8" } })
      ])
    ]),
  ...
  function buildCustomerCard(phone, name, addr, categories, autoOpen = false) {
      ...
      // הסטטוס הראשי הוסר מהכותרת לטובת UX נקי
