// ==UserScript==
// @name         AniPet Buyer Shortages (PRO Dashboard UI v2.13.0 - V4 Engine)
// @namespace    anipet.buyer
// @version      2.13.0
// @description  Added click-to-copy full size product image to clipboard for WhatsApp, with fallback to new tab. Updated to V4 Smart Engine.
...
(() => {
  ...
  const headerDiv = el("div", { id: "anipet-pro-header" }, [
    el("div", { style: { display: "flex", alignItems: "center", gap: "12px" } }, [
      ...
      el("div", {}, [
        ...
        el("div", { textContent: "V2.13.0 - V4 Smart Engine", style: { fontSize: "12px", color: "#94a3b8" } })
      ])
    ]),
  ...
  async function fetchAllData() {
      ...
      try {
          ...
          // Changed from mv_forecast_engine_v3 to mv_forecast_engine_v4
