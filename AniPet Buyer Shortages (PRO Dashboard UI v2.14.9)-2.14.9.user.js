// ==UserScript==
// @name         AniPet Buyer Shortages (PRO Dashboard UI v2.14.9)
...
(() => {
  ...
  const headerDiv = el("div", { id: "anipet-pro-header" }, [
    el("div", { style: { display: "flex", alignItems: "center", gap: "12px" } }, [
      ...
      el("div", {}, [ el("div", { textContent: "AniPet PRO · מערכת רכש", style: { fontSize: "16px", fontWeight: "700" } }), el("div", { textContent: "V2.14.9 - V6 Hybrid Engine (Fallback Aware)", style: { fontSize: "12px", color: "#94a3b8" } }) ])
    ]),
  ...
  function renderMainList() {
    ...
    filteredRows.forEach(r => {
        ...
        if (reliabilityCategory === 'swiss' || reliabilityCategory === 'regular') s.reliable_customers++;
        s.customers.push(r);
    });
  ...
  function buildSkuCard(s, isSearchMode = false) {
      ...
      const textArea = el("div", { style: { display: "flex", flexDirection: "column", gap: "6px" } }, [
        el("div", { style: { display: "flex", alignItems: "center", gap: "10px", flexWrap: "wrap" } }, [
          ...
          asNode(el("span", { className: "ani-badge badge-gray has-tooltip", 'data-tooltip': 'מק"ט' }, [createIconText("fa-light fa-barcode", s.recommend_sku || "", { marginLeft: "4px" })])),
